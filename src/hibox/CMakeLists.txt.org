...
SET(SOURCES sorted-array.c gslist.c avl.c avl-cmp.c blob.c blobmsg.c vlist.c kvlist.c utils.c safe_list.c runqueue.c
        md5.c base64.c base64-alloc.c sha1.c sha256.c sha512.c hmac-sha256.c
